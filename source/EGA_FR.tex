...
\input{ega1/ega1-6-fr.tex}
\input{ega1/ega1-7-fr.tex}
\input{ega1/ega1-8-fr.tex}
\input{ega1/ega1-9-fr.tex}
\input{ega1/ega1-10-fr.tex}
\input{ega1/bib-fr.tex}
\input{ega2/front-fr.tex}
\input{ega2/ega2-1-fr.tex}
\input{ega2/ega2-bibliography-fr.tex}
\input{ega2/ega2-indexes-and-contents-fr.tex}
\input{ega2/ega2-errata-addenda-fr.tex}
\input{ega3/ega3-1-fr.tex}

% EGA III, seconde partie (sections 6--7), admitted from the sealed
% direct-NUMDAM French handoff after the complete EGA III-1 source above.
\clearpage
\setcounter{section}{5}
\setcounter{subsection}{0}
\setcounter{equation}{0}
\setcounter{footnote}{0}
\input{ega3/ega3-6-fr.tex}
\input{ega3/ega3-7-fr.tex}
\end{document}
