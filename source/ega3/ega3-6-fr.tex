...
\[
  ...
  =(L_{\bullet\bullet}^{(1)}\otimes_A L_{\bullet\bullet}^{(2)})
    \otimes_B B_g.
\]
Si $M_{\bullet\bullet}^{(i)}$ est une résolution projective de
...
que
$M'_{\bullet\bullet}{}^{(i)}
=M_{\bullet\bullet}^{(i)}\otimes_{B_i}(B_i)_{g_i}$ est une résolution
...
de Cartan-Eilenberg $M_{\bullet\bullet}^{(i)}$ de
